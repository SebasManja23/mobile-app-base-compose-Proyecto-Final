...
@Composable
fun EntradasScreen(navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        Column(
            ...
            Text(text = "Aquí irá el formulario de entradas...")
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(containerColor = MaizeGreen)
            ) {
                Text(text = "Registrar")
            }
        }
